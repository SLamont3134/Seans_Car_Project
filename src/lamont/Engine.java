...
/**
 * Created an interface lamont.Engine with the following list of public method definitions. that
 * return a void: setEngineCylinders(int engineCylinders); setEngineManufacturedDate(Date date);
