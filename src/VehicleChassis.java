...
Create a concrete class named VehicleChassis that implements the interface Chassis with the following:
 ...
 • A public method named getChassisType that doesnt have a formal parameter and that returns an instance of the interface
 ...
 • A public toString method that returns the following: Chassis Name        : Chassis for the parameters.
 • Write a static main method that creates two objects, one with the default constructor and the other with the constructor with parameters.
  Give sample data
 */
public class VehicleChassis implements Chassis {
  ...
  // • Create a String named chassisName instance variable.
  String chassisName;
  String DEFAULT_Chassis = "Chassis";
  ...
  public VehicleChassis() {
    super();
    this.chassisName = DEFAULT_Chassis;
  }
