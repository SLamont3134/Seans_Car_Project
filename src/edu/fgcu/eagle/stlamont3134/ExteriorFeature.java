...
/**
 * Created a concrete class named lamont.ExteriorFeature that implements the interface
 * lamont.Feature with the following: • Created a String named exteriorFeature as an instance
 * variable. • A public default constructor without parameters that sets the exteriorFeature
 * instance variable. • An overloaded constructor with the following value: A String with a
 * parameter value of exteriorFeature • Set the exteriorFeature instance variable in both, use
 * features as String values. • A public method named getFeature that doesnt have a formal parameter
 * and that returns an instance of String. • A public method setFeature that takes a String
 * parameter exteriorFeature and that returns a void. It should set the instance variable
 * exteriorFeature. • A public toString method that returns the following: Exterior [Generic] •
 * Write a static main method that tests two scenarios: • One that prints all fuel grade values,
 * like: Exterior [Generic] Another like Exterior [Fog Lamps] • Created a String named
 * exteriorFeature as an instance variable.
 *
...
public class ExteriorFeature implements Feature {
   ...
   *
   * @param args The main method to test the lamont.ExteriorFeature class.
   */
   ...
   *
   * @return lamont.ExteriorFeature toString.
   */
